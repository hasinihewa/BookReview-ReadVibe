      ...
      <div className="relative z-10 w-full max-w-xl p-4 md:px-8 bg-white rounded-lg shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col items-center">
          <input
            ...
            className="w-full px-4 py-2 border rounded-full text-green-900 focus:outline-none focus:ring focus:ring-indigo-300"
          ...
          <button
            ...
            style={{ backgroundColor: '#6e9489' }} // Set button background color to #172b59
          >
            Join Now
          </button>
        </form>
